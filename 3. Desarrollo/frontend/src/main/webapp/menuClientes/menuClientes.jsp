         ...
         <div class="title">Clientes</div>
          <div class="user-details">
           <div class="input-box">
            ...
            <input type="text" name="txtCedula" placeholder="Digite la cédula" required value="<%= clienteConsultado.getCedulaCliente() !=null?clienteConsultado.getCedulaCliente(): ""%>">
          </div>
          <div class="input-box">
            <span class="details">Teléfono</span>
            <input type="text" id="txtTelefono" name="txtTelefono" placeholder="Digite el teléfono" value="<%= clienteConsultado.getTelefonoCliente() !=null?clienteConsultado.getTelefonoCliente(): ""%>"> 
          </div>
          <div class="input-box">
            <span class="details">Nombre Completo</span>
            <input type="text" id="txtNombre" name="txtNombre" placeholder="Digite el nombre" value="<%= clienteConsultado.getNombreCliente() !=null?clienteConsultado.getNombreCliente(): ""%>">
          </div>
          <div class="input-box">
            <span class="details">Correo Electrónico</span>
            <input type="text" id="emCorreo" name="emCorreo"placeholder="Digite el correo electrónico" value="<%= clienteConsultado.getEmailCliente() !=null?clienteConsultado.getEmailCliente(): ""%>">
          </div>
          <div class="input-box">
            <span class="details">Dirección</span>
            <input type="text" id="txtDireccion" name="txtDireccion" placeholder="Digite la dirección" value="<%= clienteConsultado.getDireccionCliente() !=null?clienteConsultado.getDireccionCliente(): ""%>">
          </div>
         </div>
