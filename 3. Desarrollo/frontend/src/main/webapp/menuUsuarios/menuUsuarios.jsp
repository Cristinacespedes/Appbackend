    ...
    <div class="content">
        ...
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" id="txtCedula" required="required" name="txtCedula" maxlength="20" placeholder="Digite su cédula" value="<%= dtoConsultado.getCedulaUsuario() !=null?dtoConsultado.getCedulaUsuario():"" %>">
          </div>
          <div class="input-box">
            <span class="details">Usuario</span>
            <input type="text" id="txtUsuario" name="txtUsuario" maxlength="255" placeholder="Digite su usuario" value="<%= dtoConsultado.getUsuario() !=null?dtoConsultado.getUsuario():"" %>">
          </div>
          <div class="input-box">
            <span class="details">Nombre Completo</span>
            <input type="text" id="txtNombre" name="txtNombre" maxlength="255" placeholder="Digite su nombre" value="<%= dtoConsultado.getNombreUsuario() !=null?dtoConsultado.getNombreUsuario():"" %>">
          </div>
          <div class="input-box">
            <span class="details">Contraseña</span>
            <input type="password" id="pwdContrasena" name="pwdContrasena" maxlength="255" placeholder="Digite su contraseña" value="<%= dtoConsultado.getPassword() !=null?dtoConsultado.getPassword():"" %>">
          </div>
          <div class="input-box">
            <span class="details">Correo Electrónico</span>
            <input type="email" id="emCorreo" name="emCorreo" maxlength="255" placeholder="Digite su correo electrónico" value="<%= dtoConsultado.getEmailUsuario() !=null?dtoConsultado.getEmailUsuario():"" %>">
          </div>
         </div>
